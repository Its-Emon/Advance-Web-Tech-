...
Route::get('/confirm_order/{id}',[OrderController::class,'DelOrderConfirm']);
Route::get('/on_the_way',[OrderController::class,'OnTheWayOrder']);
Route::post('/delivered',[OrderController::class,'Delivered']);
Route::get('/delivered_history/{id}',[DeliveryController::class,'DeliveryHistory']);
