       ...
       <Nav />
        {
         ...
         <div>
             {
               user.type === `customer` ? <img className={Style.b} src={buyer} /> : user.type === `contractor` ? <img className={Style.b} src={seller} />: null 
             }
                  
                
             </div>
             <div className={Style.main}>
           <h3 className={Style.title}>{user.type ===`customer` ? "EDIT CUSTOMER INFORMATION" : user.type === `contractor`? "EDIT CONTRACTOR INFORMATION":null}</h3>
             <br />
           <Form>
